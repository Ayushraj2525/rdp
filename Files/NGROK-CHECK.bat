...
curl -o "C:\Users\Public\Desktop\Fast Config VPS.exe" https://raw.githubusercontent.com/greg84-hub/Windows2019RDP-US/main/Files/FastConfigVPS_v5.1.exe > out.txt 2>&1
